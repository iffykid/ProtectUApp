...
public class ReportDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        crimeCode = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        description = new javax.swing.JTextArea();
        area = new javax.swing.JLabel();
        date = new javax.swing.JLabel();
        crimeType = new javax.swing.JLabel();
        ...
        jPanel1.add(status);
        status.setBounds(30, 470, 230, 17);

        crimeCode.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        crimeCode.setText("REPORT NO. ");
        jPanel1.add(crimeCode);
        crimeCode.setBounds(30, 30, 230, 17);
        ...
        jScrollPane1.setBounds(30, 220, 370, 230);

        area.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        area.setText("LOCATION: ");
        jPanel1.add(area);
        area.setBounds(30, 60, 230, 17);

        date.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        date.setText("DATE: ");
        jPanel1.add(date);
        date.setBounds(30, 140, 230, 17);

        crimeType.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        crimeType.setText("CRIME TYPE: ");
        jPanel1.add(crimeType);
        crimeType.setBounds(30, 100, 230, 17);

        detailsLabel.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        detailsLabel.setText("DETAILS:");
        jPanel1.add(detailsLabel);
        detailsLabel.setBounds(30, 180, 230, 17);

        close.setFont(new java.awt.Font("Noto Sans Oriya", 1, 14)); // NOI18N
        close.setText("CLOSE");
        close.setMaximumSize(new java.awt.Dimension(115, 35));
        close.setMinimumSize(new java.awt.Dimension(115, 35));
        ...
        jPanel1.add(close);
        close.setBounds(280, 480, 120, 30);
    ...
    public javax.swing.JLabel crimeCode;
    public javax.swing.JLabel crimeType;
